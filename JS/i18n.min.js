...
let fr = [
    ...
    {
      sophroUl2Li4: "⬧ Augmentation de la confiance en soi, de l'estime de soi",
    },
    {
      sophroUl2Li5:
    ...
    {
      reikiUl1Li11: "⬧ Aide à se maintenir en bonne santé et dans le bien-être",
    },
    ...
    {
      contactPhone:
        '<a class="btn btn-icon btn-phone" href="tel:+33650335412"><i class="fas fa-phone"></i><span>+33650335412</span></a>',
    },
  ],
  en = [
    ...
    {
      contactForm:
        '<a href="https://forms.gle/42yqmJ26zecSsn5i9" aria-label="contact form"><img loading="lazy"   src="/assets/images/formen.webp" alt=""></a>',
    },
    {
    ...
    {
      contactPhone:
        '<a class="btn btn-icon btn-phone" href="tel:+353870623425"><i class="fas fa-phone"></i><span>+353870623425</span></a>',
    },
  ];
...
function setLang() {
  (loader.style.display = "block"),
    window.scrollTo(0, 0),
    setTimeout(function () {
      (loader.style.display = "none"), (header.style.zIndex = "999");
    }, 1700),
    html.setAttribute("lang", chosenLang),
    "fr" === html.getAttribute("lang")
      ? writeInFrench()
      : "en" === html.getAttribute("lang") && writeInEnglish();
}
function switchLang() {
  "fr" === html.getAttribute("lang")
...
function writeInFrench() {
  i18n.forEach((e) => {
    let i = e.getAttribute("data-i18n"),
      o = fr.find((e) => Object.keys(e)[0] === i);
    if (o) {
      let i = Object.values(o)[0];
      e.innerHTML = i;
    }
  });
}
